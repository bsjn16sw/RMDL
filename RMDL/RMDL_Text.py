...
def Text_Classification(x_train, y_train, x_test,  y_test, batch_size=128,
    ...
    while i < random_deep[0]:
        ...
        try:
            print("DNN " + str(i))
            filepath = "/gdrive/My Drive/paper-classification/weights/weights_DNN_" + str(i) + ".hdf5"
    ...
    while i < random_deep[1]:
        try:
            print("RNN " + str(i))
            "/gdrive/My Drive/paper-classification/weights/weights_RNN_" + str(i) + ".hdf5"
            checkpoint = ModelCheckpoint(filepath,
                                         monitor='val_acc',
                                         verbose=1,
                                         save_best_only=True,
    ...
    while i < random_deep[2]:
        try:
            ...
            "/gdrive/My Drive/paper-classification/weights/weights_CNN_" + str(i) + ".hdf5"
